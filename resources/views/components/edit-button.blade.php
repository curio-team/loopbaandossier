<div class="fixed bottom-0 right-0 flex flex-col items-center">
    ...
    @endif
    <a href="{{route('manage_'.Route::currentRouteName(), $student->slug) }}" class="mb-8 my-14 mx-4 float-right px-5 py-2 bg-blue-500 hover:bg-blue-300 text-white font-bold tracking-wide rounded-full focus:outline-none text-lg">
